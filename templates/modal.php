...
/**
 * Modal Template
 * Renders the search modal for the Treyworks Search plugin.
 */

// Get the modal title from options, with a default fallback
$modal_title = get_option('qss_plugin_modal_title', __('Search the site', 'treyworks-search'));
$search_input_placeholder = get_option('qss_plugin_search_input_placeholder', __('Refine your search...', 'treyworks-search'));
...
<div id="qss-modal" class="qss-modal">
    <div class="qss-modal-content">
        <div class="qss-modal-header">
            ...
            <button class="qss-close-modal" aria-label="<?php echo esc_attr__('Close modal', 'treyworks-search'); ?>">&times;</button>
        </div>
        ...
        <div class="qss-modal-search-container">
            <div class="qss-modal-search">
                ...
                <button id="qss-modal-search-button" class="qss-search-button" aria-label="<?php echo esc_attr__('Search', 'treyworks-search'); ?>">
            ...
            <div id="qss-common-questions" class="qss-common-questions">
                <div class="qss-common-questions-header">
                    <div class="qss-common-questions-title"><?php echo esc_html__('Common Questions:', 'treyworks-search'); ?></div>
                    <button type="button" class="qss-dismiss-questions" aria-label="<?php echo esc_attr__('Dismiss common questions', 'treyworks-search'); ?>">
